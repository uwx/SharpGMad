...
namespace System
{
    ...
    internal static class Int32Extensions
    {
        ...
        /// </summary>
        private static string[] suffices = { "B", "KiB", "MiB", "GiB", "TiB", "PiB", "EiB", "ZiB", "YiB" };
        ...
        public static string HumanReadableSize(this int size)
        {
            ...
            var power = Math.Log(absSize, 1024);
            var unit = (int)power >= suffices.Length
                ? suffices.Length - 1
                : (int)power;
            var normSize = absSize / Math.Pow(1024, unit);
